...
3. **Geofence** (OwnTracks) — home/away/work/uni zones
...
14 automations ported from Home Assistant:
...
3. Add to config: `smart_room.tuya.bulb.local_key` and `smart_room.tuya.he20.local_key`
...
### OwnTracks (iPhone location)
1. Install OwnTracks app from App Store
2. Configure MQTT broker: your Mosquitto IP, port 1883
3. Set up waypoints: home, university, bakery
4. App publishes enter/leave events automatically in background
